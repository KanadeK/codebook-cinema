# Competitor scan (2026-07-22)

Account preflight used `gh auth status` and `gh api user`: **KanadeK** (GitHub id `121669563`). Exact GitHub searches for `"Codebook Cinema"` and `codebook-cinema` returned no public repositories. A sampled search of adjacent work found the following relevant public projects.

| Repository | Stars | Updated (UTC) | Primary focus | Overlap / distinction |
| --- | ---: | --- | --- | --- |
| [es-analysis/plato](https://github.com/es-analysis/plato) | 4555 | 2026-07-18 | JavaScript static analysis and complexity | Visualizes source metrics, not teaching chapters or narrated shots. |
| [fzaninotto/CodeFlower](https://github.com/fzaninotto/CodeFlower) | 706 | 2026-07-09 | D3 source-code graph | Graph-only visualization; no editable presentation script. |
| [X-SLAYER/code_timeline_preview](https://github.com/X-SLAYER/code_timeline_preview) | 195 | 2026-03-22 | Code visual timelines | Timeline visualization; no repository evidence model. |
| [realvizu/QuickDiagram](https://github.com/realvizu/QuickDiagram) | 143 | 2026-03-01 | C# structure diagrams | IDE navigation for C#, unlike offline Python/TypeScript teaching output. |
| [quantifiedcode/code-is-beautiful](https://github.com/quantifiedcode/code-is-beautiful) | 135 | 2026-04-30 | Collection of visualizations | Curated visual examples, not a repository analysis product. |
